#
#  Be sure to run `pod spec lint AutoKeyboard.podspec' to ensure this is a
...
#s.license      = "MIT"
  ...
  # s.social_media_url   = "http://twitter.com/Chandan"
...
#s.platform     = :ios
  ...
  s.source       = { :git => "https://github.com/chanonly123/AutoKeyboard", :tag => "#{s.version}" }
  ...
  s.source_files  = "AutoKeyboard", "AutoKeyboard/**/*.{h,m,swift}"
